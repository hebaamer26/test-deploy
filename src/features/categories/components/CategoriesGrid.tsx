      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="flex items-center gap-3 mb-6 sm:mb-8">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-400 rounded-xl flex items-center justify-center shrink-0">
            <BsGrid3X3Gap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
          </div>
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Categories</h1>
            <p className="text-sm sm:text-base text-gray-600 mt-1">Shop by category</p>
          </div>
        </div>
